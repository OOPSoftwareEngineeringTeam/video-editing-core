...
function Gallery() {
  ...
  const handleUploadClick = async () => {
    ...
    if (typeAdd === 0) {
      ...
      formData.append("width", 0); // startTime is always 0
      formData.append("height", Math.round(duration)); // endTime is the duration of the media
    }
      ...
      return new Promise((resolve, reject) => {
        ...
        audioElement.addEventListener('loadedmetadata', () => {
          if (audioElement.duration === Infinity) {
            // In case duration was incorrectly read as Infinity
        ...
        audioElement.addEventListener('error', () => reject('Error loading audio file'));
      });
    }
